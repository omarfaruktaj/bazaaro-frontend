      ...
      <div className="container mx-auto max-w-6xl">
        ...
        {cart?.cartItems.length === 0 || error ? (
          <Card className="border-0 rounded-xl shadow-none ">
            <CardContent className="flex flex-col items-center justify-center py-20 px-6 text-center shadow-none">
              ...
              <p className="text-gray-500 mb-10 max-w-md">
                You haven't added any items yet. Discover our bestsellers and
                new arrivals to get started!
              </p>
              <Button
                    ...
                    <div className="space-y-4">
                      ...
                      {totalSavings() > 0 && (
                        <div className="bg-green-50 border border-green-100 rounded-md p-3 text-sm text-green-800 flex items-start">
                          ...
                          <span>
                            You're saving{" "}
                            <strong>${totalSavings().toFixed(2)}</strong> on
                            your order today!
                          </span>
                        </div>
                      )}
