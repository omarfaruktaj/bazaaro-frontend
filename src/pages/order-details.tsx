...
export default function OrderDetails() {
  ...
  const handlePrint = () => {
    const el = printRef.current ?? document.getElementById("printable-order");
    if (!el) {
      console.warn("There is nothing to print: printable element not found.");
      return;
    }
    ...
    const styleHref = `${location.origin}/index.css`;
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Order summary card */}
        <div ref={printRef} id="printable-order">
